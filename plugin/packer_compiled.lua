...
_G.packer_plugins = {
  ...
  ["graphviz.vim"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/graphviz.vim",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["rainbow_parentheses.vim"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/rainbow_parentheses.vim",
