...
_G.packer_plugins = {
  ...
  ["ansible-vim"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/ansible-vim",
  ...
  black = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/elias/.local/share/nvim/site/pack/packer/opt/black",
    url = "https://github.com/psf/black"
  },
  catppuccin = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["cmp-calc"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/cmp-calc",
    url = "https://github.com/hrsh7th/cmp-calc"
  },
  ["cmp-emoji"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/cmp-emoji",
    url = "https://github.com/hrsh7th/cmp-emoji"
  },
  ["cmp-look"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/cmp-look",
  ...
  ["cmp-nvim-ultisnips"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/cmp-nvim-ultisnips",
  ...
  ["colorful-winsep.nvim"] = {
    ...
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/colorful-winsep.nvim",
  ...
  ["colortils.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/elias/.local/share/nvim/site/pack/packer/opt/colortils.nvim",
  ...
  ["indent-blankline.nvim"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/indent-blankline.nvim",
  ...
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim",
  ...
  ["markdown-preview.nvim"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/markdown-preview.nvim",
  ...
  ["no-neck-pain.nvim"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/no-neck-pain.nvim",
    url = "https://github.com/shortcuts/no-neck-pain.nvim"
  },
  ["nvim-FeMaco.lua"] = {
    config = { 'require("femaco").setup()' },
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/nvim-FeMaco.lua",
    url = "https://github.com/AckslD/nvim-FeMaco.lua"
  },
  ["nvim-autopairs"] = {
    config = { "\27LJ\2\n@\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0004\2\0\0B\0\2\1K\0\1\0\nsetup\19nvim-autopairs\frequire\0" },
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/nvim-autopairs",
  ...
  ["nvim-treesitter-textobjects"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/elias/.local/share/nvim/site/pack/packer/opt/nvim-treesitter-textobjects",
  ...
  ["nvim-ts-rainbow2"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/elias/.local/share/nvim/site/pack/packer/opt/nvim-ts-rainbow2",
    url = "https://github.com/HiPhish/nvim-ts-rainbow2"
  },
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/elias/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  ultisnips = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/ultisnips",
  ...
  ["vim-commentary"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/vim-commentary",
    url = "https://github.com/tpope/vim-commentary"
  },
  ["vim-dadbod"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/vim-dadbod",
    url = "https://github.com/tpope/vim-dadbod"
  },
  ["vim-dadbod-ui"] = {
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/vim-dadbod-ui",
  ...
  ["vim-hexokinase"] = {
    config = { "\27LJ\2\n³\1\0\0\2\0\a\0\r6\0\0\0009\0\1\0005\1\3\0=\1\2\0006\0\0\0009\0\1\0'\1\5\0=\1\4\0006\0\0\0009\0\1\0'\1\5\0=\1\6\0K\0\1\0\30Hexokinase_optOutPatterns\31full_hex,rgb,rgba,hsl,hsla\29Hexokinase_optInPatterns\1\2\0\0\fvirtual\28Hexokinase_highlighters\6g\bvim\0" },
    loaded = true,
    path = "/home/elias/.local/share/nvim/site/pack/packer/start/vim-hexokinase",
...
pcall(vim.api.nvim_create_user_command, 'Black', function(cmdargs)
          require('packer.load')({'black'}, { cmd = 'Black', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
